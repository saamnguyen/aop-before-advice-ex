package com.spring.aopbeforeadviceexample.aspect;
...
public class EmployeeServiceAspect {
    @Before(value = "execution(* com.spring.aopbeforeadviceexample.service.EmployeeService.*(..)) and args(empId, fname, sname)")
